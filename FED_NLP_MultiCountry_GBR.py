# %% [markdown]
# # newFedSignal — US Federal Reserve GBR Model
# **Model**: GradientBoostingRegressor with NLP + Regime Features (Walk-Forward CV)
# **Target**: 1Y yield change, ~60 trading days after FOMC meeting
#
# **Features**: 2Y-FF spread · core PCE YoY · NLP hawkishness (demeaned) · NLP vs regime
# surprise · NLP momentum · sentence dispersion · economic regime (ordinal)
#
# **Highlights**: GBR replaces OLS · walk-forward replaces LOO · FRED + FOMC caching
# · regime classification + feature engineering
# %%
import os
import pickle
import json
...
# %%
# ══════════════════════════════════════════════════════════════════════════════
# FRED DATA (cached) + REGIME CLASSIFICATION + FOMC SCRAPING (cached)
# ══════════════════════════════════════════════════════════════════════════════
...
# %%
# ══════════════════════════════════════════════════════════════════════════════
# NLP — Fine-Tune DistilBERT (30 epochs, 88 sentences) + Score Statements
# ══════════════════════════════════════════════════════════════════════════════
...
ax1.set_title(f'GBR Pred vs Actual  (OOS R²={us_oos_r2:+.3f}, Dir={us_dir_acc:.1f}%)', fontsize=11)
